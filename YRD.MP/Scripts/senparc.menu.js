...
senparc.menu = {
    ...
    init: function () {
        ...
        $('#menuLogin_Submit').click(function () {
            $.getJSON('/MPMenu/GetToken?t=' + Math.random(), { appId: $('#menuLogin_AppId').val(), appSecret: $('#menuLogin_AppSecret').val() },
                function (json) {
        ...
        $('#btnGetMenu').click(function () {
            ...
            $.getJSON('/MPMenu/GetMenu?t=' + Math.random(), { token: senparc.menu.token }, function (json) {
                if (json.menu) {
        ...
        $('#btnDeleteMenu').click(function () {
            ...
            $.getJSON('/MPMenu/DeleteMenu?t=' + Math.random(), { token: senparc.menu.token }, function (json) {
                if (json.Success) {
        ...
        $('#submitJsonMenu').click(function () {
            ...
            $.post('/MPMenu/CreateMenuFromJson', { token: $('#tokenStr').val(), fullJson: jsonStr }, function (json) {
                if (json.Success) {
                    menuState.html('上传成功');
                } else {
                    menuState.html(json.Message);
