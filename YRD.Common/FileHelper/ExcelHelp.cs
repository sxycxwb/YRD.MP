...
namespace Common
{
    public class ExcelHelp
    {
        ...
        public static void ToExcelByNPOI(System.Collections.IEnumerable list, string strExcelFileName, List<KeyValuePair<string, string>> fields = null, string title = "")
        {
            try
            {
                HSSFWorkbook workbook = new HSSFWorkbook();
                ...
                if (string.IsNullOrEmpty(title) == false)
                {
                    ...
                    sheet.AddMergedRegion(new NPOI.SS.Util.CellRangeAddress(0, 0, 0, fields.Count - 1));
                    var value = title;
                    if (value != null)
                    {
                        cell.SetCellValue(value.ToString());
                            ...
                            foreach (var field in fields)
                            {
                                ...
                                if (p != null)
                                {
                                    ...
                                    if (value != null)
                                    {
                                        ...
                                        {
                                            cell.SetCellValue(DateTime.Parse(value.ToString()).ToString(FormatHelper.DataTimeFormat));
                                        }
                                        else
                                        {
                                            cell.SetCellValue(value.ToString());
