    ...
    uploader.on('error', function( code ) {
        ...
        switch( code ) {
            case  'F_DUPLICATE' : text = '该图片已经被选择了!' ;
                break;
            case  'Q_EXCEED_NUM_LIMIT' : text = '上传图片数量超过限制，最多上传'+n+'张图片!' ;
                break;
            case  'F_EXCEED_SIZE' : text = '图片大小超过限制，每张图片最大为'+s+'M!';
                break;
            case  'Q_EXCEED_SIZE_LIMIT' : text = '所有图片总大小超过限制，每张图片最大为'+s+'M!';
                break;
